...
(function() {
  ...
  AbstractChosen = (function() {
    ...
    AbstractChosen.prototype.winnow_results = function() {
      var aroundText, escapedSearchText, match, option, regex, regexAnchor, results, results_group, searchText, startpos, text, zregex, _i, _len, _ref;
  ...
  Chosen = (function(_super) {
    ...
    Chosen.prototype.set_up_html = function() {
      ...
      this.container = ($("<div />", container_props)).css('width', this.container_width());
      if (this.is_multiple) {
